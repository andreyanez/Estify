...
export function PhoneFrame({ children }: { children: any }) {
	return (
		<div className="relative aspect-[366/729] mx-auto max-w-[366px]">
			...
			<div className="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-primary pt-[calc(23/318*100%)]">
				{children}
			</div>
			<PlaceholderFrame className="pointer-events-none absolute inset-0 h-full w-full fill-gray-100" />
			<img src={frame} alt="" className="pointer-events-none absolute inset-0 h-full w-full" />
		</div>
	);
}
