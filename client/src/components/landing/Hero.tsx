				...
				<div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
					<div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
						...
						<p className="mt-6 text-lg text-neutral">
							Estify te da un recuento en tiempo real de tu data en Spotify. Visualiza las
							propiedades auditivas de tus playlists, artistas y tracks favoritos, así como tus
					...
					<div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
						...
						<div className="-mx-4 hidden h-[448px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 md:block lg:absolute lg:-inset-x-10 lg:-top-10 lg:-bottom-20 lg:h-auto lg:px-0 lg:pt-10 xl:-bottom-32">
							<img src="/estify.png" className="" alt="estify" />
							{/* <PhoneFrame>
								<picture>
